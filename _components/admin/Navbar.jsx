...
export default function Navbar(props) {
  ...
  return (
    <header className="sticky top-0 z-999 flex w-full bg-[#24303F] drop-shadow-none text-white">
      <div className="flex flex-grow items-center justify-between px-4 py-4 shadow-2 md:px-6 2xl:px-11">
        <div className="flex items-center gap-2 sm:gap-4 lg:hidden">
          <button
            ...
            className="z-99999 block rounded-sm border p-1.5 shadow-sm border-strokedark bg-[#24303F] lg:hidden"
          >
          ...
          >
            ...
            >
              <span className="hidden text-right lg:block">
                ...
                <User size={40} className='border-2 rounded-full p-1'/>
            ...
            {dropdownOpen && (
              <div
                className={`absolute right-0 mt-4 flex w-62.5 flex-col rounded-sm border border-stroke shadow-default border-strokedark bg-[#24303F]`}
              >
                <ul className="flex flex-col gap-5 border-b border-stroke px-6 py-7.5 border-strokedark">
                  <li>
                    <Link
                      href="/profile"
