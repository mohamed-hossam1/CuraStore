...
export default function ProductShow({ product }) {
  ...
  return (
    <main>
      ...
      <section id="related-products" className="py-20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-4">
              Complete Your <span className="text-sky-600">Setup</span>
            </h2>
            <p className="text-xl">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white rounded-2xl p-6 border-2 border-gray-200 group">
              {/* // */}
            </div>
          </div>

          <div className="text-center mt-12">
            <button className="cursor-pointer hover:bg-sky-600 text-sky-700 hover:text-white transition-colors duration-200 px-8 py-4 rounded-full font-semibold border-2 border-sky-600">
